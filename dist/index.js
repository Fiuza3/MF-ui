...
function Logo({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
    "svg",
    {
      ...
      className,
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("text", { ...textoBase, x: padX, fillOpacity: opColchetes, children: "<" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("text", { ...textoBase, x: padX + cw, children: "MF" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("text", { ...textoBase, x: padX + cw * 3, fillOpacity: opColchetes, children: "/>" })
      ]
    }
  );
}
          ...
          /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
            import_framer_motion3.motion.div,
            {
              ...
              children: stats.map((stat) => /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("p", { className: "font-mono text-3xl font-black text-foreground sm:text-4xl", children: stat.value }),
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("div", { className: "w-full px-5 sm:px-8 lg:px-10 2xl:px-14", children: [
        /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)(
          import_framer_motion4.motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("p", { className: "font-mono text-xs uppercase tracking-[0.34em] text-cyan", children: eyebrow }),
              /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("div", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("h2", { className: "max-w-5xl text-[clamp(2.25rem,6vw,6.6rem)] font-black leading-[0.94] tracking-tight text-foreground", children: titulo }),
                /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("p", { className: "mt-6 max-w-3xl text-base leading-relaxed text-gray-text", children: descricao })
              ] })
            ]
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("div", { className: "grid auto-rows-fr gap-6 lg:grid-cols-3", children: services.map((service, i) => /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(ServiceCard, { service, index: i }, service.id)) })
      ] })
    }
  );
}
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("div", { className: "w-full px-5 sm:px-8 lg:px-10 2xl:px-14", children: /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)(
          import_framer_motion5.motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("p", { className: "font-mono text-xs uppercase tracking-[0.34em] text-cyan", children: eyebrow }),
              /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)("div", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("h2", { className: "max-w-6xl text-[clamp(2.3rem,7vw,7.8rem)] font-black leading-[0.94] tracking-tight text-foreground", children: titulo }),
                /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("p", { className: "mt-6 max-w-3xl text-base leading-relaxed text-gray-text", children: descricao })
              ] })
            ]
          }
        ) }),
...
function PipelineCard({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(
    import_framer_motion6.motion.article,
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("div", { className: alignRight ? "lg:col-start-2" : "lg:col-start-1", children: /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: "group relative overflow-hidden rounded border border-line bg-surface p-6 transition-colors hover:border-cyan/60 lg:p-8", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: "relative", children: [
            /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: "flex items-start justify-between gap-5", children: [
              /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("p", { className: "font-mono text-xs uppercase tracking-[0.28em] text-cyan", children: [
                  "commit ",
                  step.numero
                ] }),
                /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("h3", { className: "mt-4 text-[clamp(1.8rem,4vw,4.8rem)] font-black leading-[0.9] tracking-tight text-foreground", children: step.titulo })
              ] }),
              step.duracao && /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("span", { className: "rounded border border-line px-3 py-1 font-mono text-xs text-gray-text", children: step.duracao })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("p", { className: "mt-6 max-w-2xl text-base leading-relaxed text-gray-text", children: step.descricao }),
            (step.commitLabel || step.commitOutput) && /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: "mt-8 border-t border-line pt-5 font-mono", children: [
              step.commitLabel && /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("p", { className: "text-sm text-foreground", children: [
                /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("span", { className: "text-cyan", children: "$" }),
                " git commit -m \u201C",
                step.commitLabel,
                "\u201D"
              ] }),
              step.commitOutput && /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("p", { className: "mt-2 text-xs text-gray-text", children: [
                /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("span", { className: "text-cyan/70", children: ">" }),
                " ",
                step.commitOutput
              ] })
            ] })
...
function Process({ eyebrow, titulo, descricao, steps }) {
  ...
  const lineScale = (0, import_framer_motion6.useTransform)(scrollYProgress, [0, 1], [0, 1]);
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: "w-full px-5 sm:px-8 lg:px-10 2xl:px-14", children: [
        /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(
          import_framer_motion6.motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("p", { className: "font-mono text-xs uppercase tracking-[0.34em] text-cyan", children: eyebrow }),
              /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("h2", { className: "max-w-6xl text-[clamp(2.3rem,7vw,7.8rem)] font-black leading-[0.94] tracking-tight text-foreground", children: titulo }),
                /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("p", { className: "mt-6 max-w-3xl text-base leading-relaxed text-gray-text", children: descricao })
              ] })
            ]
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: "process-pipeline relative", children: [
          /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(
            "div",
            {
              "aria-hidden": "true",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("div", { className: "grid gap-8 lg:gap-12", children: steps.map((step, index) => /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(PipelineCard, { step, index }, step.numero)) })
        ] })
      ] })
    }
  );
...
function Stack({ eyebrow, titulo, descricao, grupos }) {
  ...
  const [active, setActive] = (0, import_react4.useState)(grupos[0]);
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("div", { className: "w-full px-5 sm:px-8 lg:px-10 2xl:px-14", children: [
        /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)(
          import_framer_motion7.motion.div,
          {
            ...
            className: "mb-16 grid gap-8 lg:grid-cols-[0.8fr_1.7fr]",
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("p", { className: "font-mono text-xs uppercase tracking-[0.34em] text-cyan", children: eyebrow }),
              /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("div", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("h2", { className: "max-w-6xl text-[clamp(2.3rem,7vw,7.8rem)] font-black leading-[0.94] tracking-tight text-foreground", children: titulo }),
                /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("p", { className: "mt-6 max-w-3xl text-base leading-relaxed text-gray-text", children: descricao })
              ] })
            ]
          }
        ),
...
function Testimonials({
  ...
  const [userPaused, setUserPaused] = (0, import_react5.useState)(false);
        ...
        /* @__PURE__ */ (0, import_jsx_runtime23.jsxs)("div", { className: "w-full px-5 sm:px-8 lg:px-10 2xl:px-14", children: [
          /* @__PURE__ */ (0, import_jsx_runtime23.jsxs)(
            import_framer_motion10.motion.div,
            {
              ...
              className: "mb-16 grid gap-8 lg:grid-cols-[0.8fr_1.7fr]",
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("p", { className: "font-mono text-xs uppercase tracking-[0.34em] text-cyan", children: /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("span", { lang: "en", children: eyebrow }) }),
                /* @__PURE__ */ (0, import_jsx_runtime23.jsxs)("div", { children: [
                  /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("h2", { className: "max-w-6xl text-[clamp(2.3rem,7vw,7.8rem)] font-black leading-[0.94] tracking-tight text-foreground", children: titulo }),
                  /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("p", { className: "mt-6 max-w-3xl text-base leading-relaxed text-gray-text", children: descricao })
                ] })
              ]
            }
          ),
